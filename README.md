...
## Overview
This repository implements spatially-balanced sampling designs for official statistics, with a focus on integrating geographic information into Primary Sampling Unit selection.
